...
class STAMP:
    ...
    def train(self, ):
        ...
        dataset_val = PerturbDataSet(self.config['dataset']['Validation_dataset'], self.Gene_embeddings)
        ...
        for epoch in range(1, epochs + 1):
            ...
            logger.info('Epoch:[{}/{}]\tsteps:{}\tloss1_train:{:.5f}\tloss2_train:{:.5f}\tloss3_train:{:.5f}\tloss1_val:{:.5f}\tloss2_val:{:.5f}\tloss3_val:{:.5f}\ttime:{:.3f}'.format(epoch, epochs, idx + 1, 
